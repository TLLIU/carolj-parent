package idv.tlliu.springboot.sample.rest.controllers;

import static idv.tlliu.springboot.sample.rest.dtos.UserConversor.toAuthenticatedUserDto;
import static idv.tlliu.springboot.sample.rest.dtos.UserConversor.toUser;
import static idv.tlliu.springboot.sample.rest.dtos.UserConversor.toUserDto;
...
import idv.tlliu.springboot.sample.model.services.exceptions.IncorrectLoginException;
import idv.tlliu.springboot.sample.model.services.exceptions.IncorrectPasswordException;
import idv.tlliu.springboot.sample.model.services.exceptions.PermissionException;
import idv.tlliu.springboot.sample.model.services.UserService;
import idv.tlliu.springboot.sample.rest.common.ErrorsDto;
import idv.tlliu.springboot.sample.rest.common.JwtGenerator;
import idv.tlliu.springboot.sample.rest.common.JwtInfo;
import idv.tlliu.springboot.sample.rest.dtos.AuthenticatedUserDto;
import idv.tlliu.springboot.sample.rest.dtos.ChangePasswordParamsDto;
import idv.tlliu.springboot.sample.rest.dtos.LoginParamsDto;
import idv.tlliu.springboot.sample.rest.dtos.UserDto;
...
public class UserController {
  ...
  @GetMapping("")
  public List<UserDto> updateProfile(@RequestAttribute Long userId)
      throws InstanceNotFoundException, PermissionException {
...
//    }
    ...
    return userService.getUsers().stream().map(users -> toUserDto(users)).toList();
